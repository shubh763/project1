...
const Basic = () =>{
    ...
    const save = () =>{
        ...
        dispatch(mydata);
        toast.success("Your basic details save successfully...");
        setName("")
        setDob("")
        setGender("")
        setMarried("")
        ...
        <div className="row">
            ...
            <div className="col-xl-7 mb-4 ">
                    <div className="card border-0 shadow-lg">
                        <div className="card-header bg-info text-white"> <i class="fa fa-info-circle" aria-hidden="true"></i> Basic Information </div>
